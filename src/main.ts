...
let arraySeries: Serie[] = [ser1, ser2, ser3, ser4, ser5];
...
let arrayVideojuego : Videojuego[] = [vid1, vid2, vid3, vid4, vid5];
...
let contadorTemporadas : Serie = arraySeries[0];
...
let contadorHoras : Videojuego = arrayVideojuego[0];
